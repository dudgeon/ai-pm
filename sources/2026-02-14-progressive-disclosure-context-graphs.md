...
- [Progressive Tool Disclosure](../knowledge-base/horizontal/agents/progressive-tool-disclosure.md) — Revealing tools in layers to combat MCP tool overload (+15% accuracy)
