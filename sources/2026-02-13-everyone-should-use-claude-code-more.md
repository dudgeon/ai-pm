...
Lenny argues Claude Code is the best consumer AI product and that non-technical people should be using it far more. Lists 50 ways people use it for non-coding tasks. Partial content available (paywall hit at item ~16).

Visible use cases include:
- Trip planning with real-time research
