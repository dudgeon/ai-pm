...
**Context**: Observation from thinking about AI adoption patterns in non-AI-native organizations — the tension between broad shallow adoption and deep narrow adoption.
**How you use it**: As a lens for evaluating whether an AI adoption strategy is balanced and self-reinforcing, and for classifying AI tools by which axis they primarily serve.
**Why it works**: It names the two distinct motions that "AI adoption" actually requires, prevents conflating them, and creates a framework for sequencing investments.
